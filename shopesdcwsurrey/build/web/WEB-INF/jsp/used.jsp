    ...
    <section id="mainContent">
        <div id="content">
            ...
            <section id="pages-details">
                <h1>Used Books</h1>
                <div class="pages-img">
                    <img class="apnlogo" src="resources/images/pages/used.png" title="APN online store" alt="Book Store" />
                </div>
                <div class="pages-text">
                    <p>U The ANP Online store included more than 1000 books which categories up to 5 categories.
           ...
           <section id="pages-content">
            <!--Latest Product-->
            <div class="box">
                <div class="box-heading-1"><span>Used Books</span></div>
